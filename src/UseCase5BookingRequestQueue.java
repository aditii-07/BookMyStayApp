 ...
 * Description: Represents a booking request made by a guest.
 * @version 5.0
 */
class Reservation {
 ...
 * Use Case 5: Booking Request (FIFO)
 * Description: Manages booking requests using a queue (FIFO).
 * @version 5.0
 */
class BookingRequestQueue {
 ...
 * Use Case 5: Booking Request (FIFO)
 * Description: Demonstrates how booking requests are queued in a fair order.
 * @version 5.0
 */
